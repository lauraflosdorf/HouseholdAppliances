...
public static void main(String[] args) {
        ...
        MovingCostVisitor costVisitor = new MovingCostVisitor();
        householdItmes.forEach((HouseholdItem item) -> {
        	System.out.println(costVisitor.getMovingCosts(item));
		});
        
        PackingInstructionsVisitor instructionsVisitor = new PackingInstructionsVisitor();
        householdItmes.forEach((HouseholdItem item) -> {
        	System.out.println(instructionsVisitor.getPackingInstructions(item));
		});
}
